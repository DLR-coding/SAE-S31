...
int main() {
    ...
    DemandeOperation DeO4 = {4, "Go", "", 0}; // Supprimer le jeu "Echec"
    DemandeOperation DeO5 = {5, "Go", "", 0}; // Simuler un combat avec le jeu "Go"
    DemandeOperation DeO6 = {6, "Go", "", 0}; // Lancer le jeu "Go"

    // Exécution des opérations
    int res1 = execute_demande(DeO1); printf("Résultat 1 : %d\n", res1);
    int res3 = execute_demande(DeO3); printf("Résultat 3 : %d\n", res3);
    printf("liste jeux : \n") ; int res2 = execute_demande(DeO2); printf("Résultat 2 : %d\n", res2);

    printf("simulation de combat...\n");
    execute_demande(DeO5); // Pas de retour pour cette opération
    printf("fin simulation de combat\n");
    printf("on lance le jeu Go\n");
    execute_demande(DeO6); // Pas de retour pour cette opération
    printf("Fin du jeu Go\n");
    printf("suppression de Go \n");
    int res4 = execute_demande(DeO4); printf("Résultat 4 : %d\n", res4);
}
